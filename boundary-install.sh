...
# BOUNDARY INSTALLER - Automated Boundary Installation
#   Apache 2 License - Copyright (c) 2018  Robert Peteuil  @RobertPeteuil
#
#     Automatically Download, Extract and Install
#        Latest or Specific Version of Boundary
#
#   from: https://github.com/robertpeteuil/boundary-installer
...
usage() {
  [[ "$1" ]] && echo -e "Download and Install Boundary - Latest Version unless '-i' specified\n"
